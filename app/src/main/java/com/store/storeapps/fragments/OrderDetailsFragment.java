        ...
        if (myOrdersModel.getMovies() != null) {
            for (int l = 0; l < myOrdersModel.getMovies().size(); l++) {
                ...
                for (int m = 0; m < modelArray.getMovies().size(); m++) {
                    ...
                    View inneritem = mInflater.inflate(R.layout.layout_orderdetails_inneritem, null);
                    ...
                    TextView txt_qty = (TextView) inneritem.findViewById(R.id.quantityValue);
                    TextView txt_subtotal = (TextView) inneritem.findViewById(R.id.subtoatalValue);
                    TextView txt_grandtotal = (TextView) inneritem.findViewById(R.id.grandTotalValue);
                    TextView txt_addressname = (TextView) inneritem.findViewById(R.id.addresname);
                    TextView txt_addressline = (TextView) inneritem.findViewById(R.id.addresline);
                    TextView txt_addresscity = (TextView) inneritem.findViewById(R.id.addrescity);
