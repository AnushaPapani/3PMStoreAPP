...
public class Previous_ItemDetails implements Serializable {
    ...
    /*Previous_Products Data*/
    private String images;
    private String P_ID;
    private String P_P_Name;
    private String P_P_Cost;
    private String P_StrikeMrp;
    ...
    public void setP_P_Name(String p_P_Name) {
        P_P_Name = p_P_Name;
    }

    public String getP_P_Cost() {
        return P_P_Cost;
    }

    public void setP_P_Cost(String p_P_Cost) {
        P_P_Cost = p_P_Cost;
    }

    public String getP_StrikeMrp() {
        return P_StrikeMrp;
    }

    public void setP_StrikeMrp(String p_StrikeMrp) {
        P_StrikeMrp = p_StrikeMrp;
    }
